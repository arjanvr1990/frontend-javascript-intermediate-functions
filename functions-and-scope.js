...
function averageGrades(grades) {
    ...
    for (let i = 0; i < grades.length; i++) {
        gradesAddUp += grades[i];
    }
const average = gradesAddUp / grades.length;
return average;
}
...
console.log(averageGrades(grades2));
console.log(averageGrades(grades3));
...
function highestNumber(grades) {
    let highestNumberCounter = grades[0]

    for (let i = 0; i < grades.length; i++) {
        if (grades[i] > highestNumberCounter) {
            highestNumberCounter = grades[i]
        }
...
console.log(highestNumber(grades2));
console.log(highestNumber(grades3));